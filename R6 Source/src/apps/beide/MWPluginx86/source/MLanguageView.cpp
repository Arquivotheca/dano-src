	...
	BMessage&	inOutMessage)
{
	...
	inOutMessage.AddData(kLangPrefsType, kCompilerType, &fNewSettings, sizeof(fNewSettings));
	...
	BMessage&	inMessage)
{
	...
	if (B_NO_ERROR == inMessage.FindData(kLangPrefsType, kCompilerType, &prefs, &length))
	{
