...
.alignment
	%if _PROCESSOR_MMX_CYRIX_
	PADDUSB		MM0,qword[mask1]
	PAVEB 		MM0,qword[edi]
	MOVQ		qword[edi],MM0
	
	PADDUSB		MM2,qword[mask1]
	PAVEB 		MM2,qword[edi + 8]
...
.alignment2
	...
	PADDUSB		MM7,qword[mask2]
	
	PAND		MM5,qword[nonmask3]
	PSRLQ		MM5,qword[deux]
	PADDUSB		MM4,MM5
	
	PAND		MM7,qword[nonmask3]
	PSRLQ		MM7,qword[deux]
	PADDUSB		MM6,MM7
	...
	PADDUSB		MM4,qword[mask1]
	PAVEB		MM4,qword[edi]
	MOVQ		qword[edi],MM4
	
	PADDUSB		MM6,qword[mask1]
	PAVEB		MM6,qword[edi + 8]
