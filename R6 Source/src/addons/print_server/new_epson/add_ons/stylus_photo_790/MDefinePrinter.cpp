...
const char *gName = "Epson Stylus Photo 790";
const tPrinterInfo gPrinterInfo =
{
	gName,						// Name
	ID_STYLUS_PHOTO_790,		// ID
	3,							// DefaultPage
	48,							// Nb Black Nozzles
	48,							// Nb Color Nozzles
...
const tPage gPage[] = {
		...
		{ "Epson Photo Paper",		42, 1523, 42, 42, 2243, 199, M_PLAIN_FORMAT },
...
const struct
{
	...
	{ {0,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// userdef
	{ {1,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// letter
	{ {0,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// legal
	{ {1,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// a4
	{ {1,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// a5
	{ {2,1},{2,1},{6,1},{8,1},{8,1},{3,1} },	// a6
	{ {1,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// executive
	{ {1,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// half letter
	{ {2,1},{2,1},{6,1},{8,1},{8,1},{3,1} },	// index 5x8
	{ {2,1},{2,1},{6,1},{8,1},{8,1},{3,1} },	// index 8x10
	{ {4,2},{4,2},{6,2},{8,2},{8,2},{3,2} },	// #10 envelope
	{ {4,2},{4,2},{6,2},{8,2},{8,2},{3,2} },	// DL
	{ {4,2},{4,2},{6,2},{8,2},{8,2},{3,2} },	// C6
	{ {0,0},{7,0},{6,1},{8,1},{8,1},{3,0} },	// photo paper
	{ {0,0},{7,0},{6,1},{8,1},{8,1},{3,0} }		// panoramique
};
...
const tRes2Paper gRes2Paper[] =	{
									...
									{1, 1, 1,	2, 2, 0x0000 },	// 360x720 inkjet
									{3, 1, 2,	3, 2, 0x0041 },	// 1440x720 inkjet
									{1, 3, 1,	2, 2, 0x0001 },	// 360x720 photo
									{3, 3, 2,	3, 2, 0x0041 },	// 1440x720 photo
									{2, 4, 2,	1, 2, 0x0021 },	// 720x720 premium
									{3, 4, 2,	3, 2, 0x0041 },	// 1440x720 premium
									{1, 2, 1,	2, 2, 0x0001 },	// 360x720 matte
									{3, 2, 2,	3, 2, 0x0041 },	// 1440x720 matte
									{2, 5, 2,	1, 2, 0x0021 },	// 720x720 film
									{3, 5, 2,	3, 2, 0x0041 },	// 1440x720 film
								};
...
MPrinterDriver::MPrinterDriver()
{
	...
	fAttributes = EP_IS_EPSON_MODULE | EP_SUPPORTS_USB | EP_SUPPORTS_EXPANDED | EP_IS_PHOTO;
