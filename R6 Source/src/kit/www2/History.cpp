...
{
	// Add my URL
#warning "Fix me FrameSet::AddToMessage"
...
{
#warning "Fix me FrameSet::RestoreFromMessage"
...
#warning "Fix me History::BinderOpen"
		BMessage msg;
//		msg.Unflatten(buf);
		free(buf);
...
{
#warning "Fix me History::BinderPush"
...
void History::Goto(const FramePath& framePath, const BUrl& url, GroupID groupID)
{
