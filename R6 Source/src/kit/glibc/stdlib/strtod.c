...
({ \
  size_t __len = (N); \
  const CHAR_TYPE *__s1 = (CHAR_TYPE *) (S1); \
  const CHAR_TYPE *__s2 = (CHAR_TYPE *) (S2); \
  int __result = 0; \
  while (__len-- > 0) \
    { \
      __result = *__s1 - *__s2++; \
...
({ \
  size_t __len = (N); \
  const unsigned CHAR_TYPE *__s1 = (unsigned CHAR_TYPE *) (S1); \
  const unsigned CHAR_TYPE *__s2 = (unsigned CHAR_TYPE *) (S2); \
  int __result = 0; \
  while (__len-- > 0) \
    { \
      __result = *__s1 - *__s2++; \
