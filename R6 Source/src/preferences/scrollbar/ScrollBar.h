...
const rgb_color kScrollBarColor = { 216, 216, 216, 255};
...
class TScrollBarWindow : public BWindow {
public:
						TScrollBarWindow(BRect, char*);
						~TScrollBarWindow();
...
class TScrollBarApplication : public BApplication {
public:
						TScrollBarApplication();
		void			MessageReceived(BMessage*);
		void			AboutRequested();
};
