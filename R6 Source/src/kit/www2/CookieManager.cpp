...
void CookieManager::ParseCookieString(const BUrl &src, const char *string, time_t serverdate)
{
	// Values we want
...
void  CookieManager::SetCookie(const BUrl &fromPage, const char *name, const char *value,
...
void CookieManager::GetCookieValue(const BUrl &requestingURL, const char *name,
...
void CookieManager::BuildCookieString(const BUrl &url, char *out, size_t len)
{
	StringBuffer str;
...
void CookieManager::BuildCookieString(const BUrl &url, StringBuffer &str)
{
