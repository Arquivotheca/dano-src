...
static int
WrToRut(struct RUT * ruc, unsigned csn, unsigned tick)
{
	unsigned            whn;
...
static int
deleteCT(struct RUT * ruc, unsigned csn)
{
	unsigned            whn;
...
unsigned
searchRut(struct RUT * ruc, unsigned csn)
{
	unsigned            whn;
	struct CTdata      *wd;
...
static
struct CTdata      *
searchCTadd(struct RUT * ruc, unsigned csn)
{
	unsigned            whn;
	struct CTdata      *wd;
...
int
entryRut(struct RUT * ruc, unsigned csn, unsigned tick)
{
	struct CTdata      *wpadd;
	int                 retval;
...
/*ARGSUSED*/
int
FQclose(RkContext * cx, struct DM * dm, struct DM * qm, char *file)
{
...
int
FQsync(RkContext * cx, struct DM * dm, struct DM * qm, char *file)
/* ARGSUSED */
{
	struct DF          *df = qm->dm_file;
	struct xqm         *xqm;
