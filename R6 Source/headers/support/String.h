...
void				BMoveBefore(BString* to, BString* from, const size_t step = sizeof(BString), size_t count = 1);
void				BMoveAfter(BString* to, BString* from, const size_t step = sizeof(BString), size_t count = 1);
