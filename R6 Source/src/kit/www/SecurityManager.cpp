...
GroupID SecurityManager::GetGroupID(const URL &url)
{
...
void Wagner::ResourceClass::SetGroupID(GroupID groupID)
{
	fGroup = groupID;
}

bool SecurityManager::CheckAccess(const URL &url, GroupID requestorGroup)
{
...
GroupID Wagner::ResourceClass::GetGroupID() const
{
	return fGroup;
}
