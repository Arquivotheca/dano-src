#ifndef _MEDIA2_MEDIAWRITER_PRIVATE_
#define _MEDIA2_MEDIAWRITER_PRIVATE_
...
extern "C" {
	_EXPORT B::Private::MediaWriter *instantiate_mediawriter(void);
	_EXPORT status_t    get_mediawriter_info(media_file_format *mfi);
	_EXPORT status_t    accepts_format(const media_format *mf);
}
...
public:
	...
	virtual status_t	SetDestination(IByteInput::arg in,
									   IByteOutput::arg out,
									   IByteSeekable::arg seek) = 0;
...
#endif //_MEDIA2_MEDIAWRITER_PRIVATE_
