...
AApplication::AApplication():BApplication("application/x-vnd.Be-SetAppResource-Interface") {
	target=NULL;
	Run();
}
...
// create the BWindow
	...
	msg.AddString("_name","Interface");
	msg.AddRect("_frame",BRect(100,100,199,499));
	msg.AddString("_title","Interface");
