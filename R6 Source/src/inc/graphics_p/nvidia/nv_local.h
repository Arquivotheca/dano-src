 ...
 * generic in nature.
 * [[ We don't use them here.  ewhac 2001.06.28 ]]
 */ 
...
#define NV_WR08(p,i,d)  \
	*(volatile uint8 *)(((uint8*)(p)) + (i)) = (d)
#define NV_RD08(p,i)    \
	*(volatile uint8 *)(((uint8*)(p)) + (i))
#define NV_WR16(p,i,d)  \
	*(volatile uint16 *)(void *)(((uint8*)(p)) + (i)) = (d)
#define NV_RD16(p,i)    \
	*(volatile uint16 *)(void *)(((uint8*)(p)) + (i))
#define NV_WR32(p,i,d)  \
	*(volatile uint32 *)(void *)(((uint8*)(p)) + (i)) = (d)
#define NV_RD32(p,i)    \
	*(volatile uint32 *)(void *)(((uint8*)(p)) + (i))
#if 1
#define VGA_WR08(p,i,d) NV_WR08(p,i,d)
#define VGA_RD08(p,i)   NV_RD08(p,i)
#define VGA_WR16(p,i,d) NV_WR16(p,i,d)
#define VGA_RD16(p,i)   NV_RD16(p,i)
#else
#define VGA_WR08(p,i,d) outb(i,d)
#define VGA_RD08(p,i)   inb(i)
#define VGA_WR16(p,i,d) outw(i,d)
#define VGA_RD16(p,i)   inw(i)
#endif
