 ...
 *
 *
 * Rev Level: @(#)winmem.c	1.9 10/2/97
 *
 */
...
/**********************************************************************/
KpHandle_t FAR allocBufferHandle (KpInt32_t Size)
{
...
{
	return KpMemAlloc (FALSE, (KpUInt32_t) Size);
}

/**********************************************************************/
KpGenericPtr_t FAR reallocBufferPtr (KpGenericPtr_t OldPtr, KpInt32_t Size)
{
	return KpMemRealloc (FALSE, OldPtr, (KpUInt32_t) Size);
}

/**********************************************************************/
void FAR freeBuffer (KpHandle_t Handle)
{
...
/**********************************************************************/
KpInt32_t FAR getBufferSize (KpHandle_t Handle)
{
...
{
	return (KpInt32_t) KpMemGetSize (FALSE, Ptr);
}

/**********************************************************************/
KpHandle_t FAR getHandleFromPtr (KpGenericPtr_t Ptr)
{
	return (KpHandle_t) Ptr;
}

/**********************************************************************/
KpGenericPtr_t FAR lockBuffer (KpHandle_t Handle)
{
	KpMemLogLock (Handle);
...
/**********************************************************************/
bool FAR unlockBuffer (KpHandle_t Handle)
{
...
{
	return (KpHandle_t) KpMemAlloc (TRUE, (KpUInt32_t) Size);
}
...
{
	return KpMemAlloc (TRUE, (KpUInt32_t) Size);
}

/**********************************************************************/
void FAR freeSysBuffer (KpHandle_t Handle)
{
	KpMemFree (TRUE, (void FAR *) Handle);
}
...
{
	return (KpInt32_t) KpMemGetSize (TRUE, (void FAR *) Handle);
}

/**********************************************************************/
KpInt32_t FAR getSysPtrSize (KpGenericPtr_t Ptr)
{
	return (KpInt32_t) KpMemGetSize (TRUE, Ptr);
}
...
/**********************************************************************/
bool FAR unlockSysBuffer (KpHandle_t Handle)
{
	KpMemLogUnlock (Handle);
	return (NULL != Handle) ? TRUE : FALSE;
}
