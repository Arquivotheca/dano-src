...
#ifndef	_SUPPORT2_TOKENSPACE_H
#define _SUPPORT2_TOKENSPACE_H
...
public:
		...
		void					Dump(ITextOutput::arg io, bool showFree=false) const;
...
static	BTokenSpace *	gDefault;
static	BLocker			gDefaultCreationLock;
