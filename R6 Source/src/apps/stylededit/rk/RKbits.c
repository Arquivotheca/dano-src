...
int
_RkPackBits(unsigned char *dst_bits, int dst_offset, int bit_size, unsigned *src_ints, int count)
{
  unsigned char	*dstB;
  unsigned		dstQ;
  unsigned		dstCount;
...
int
_RkUnpackBits(unsigned *dst_ints, unsigned char *src_bits, int src_offset, int bit_size, int count)
{
  unsigned char	*srcB;
  unsigned		srcQ;
  unsigned		srcCount;
...
int
_RkCopyBits(unsigned char *dst_bits, int dst_offset, int bit_size, unsigned char *src_bits, int src_offset, int count)
{
  unsigned char	*dstB;
  unsigned		dstQ;
  unsigned		dstCount;
...
int
_RkSetBitNum(unsigned char *dst_bits, int dst_offset, int bit_size, int n, int val)
{
  unsigned char	*dstB;
