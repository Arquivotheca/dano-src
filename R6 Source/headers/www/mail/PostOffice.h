...
class PostOffice : public BinderNode {
	public:
		...
		virtual	void			Cleanup();
								...
								// PostOffice calls
		status_t				SyncCache(const char *username, const char *mailbox, SummaryContainer *outSummary = NULL, MailServer *inServer = NULL);
		...
		status_t				OpenServerConnection(MailServer *server, UserContainer &container, const char *mailbox = NULL, bool writable = false);
