...
const BEncodingRun		SJIS_00A1(0x00A1, 0x00DF, 0xFF61);

const uint16	SJISBlock_8140[] = {
...
const BEncodingRun		SJIS_8140(0x8140, 0x8170, SJISBlock_8140);

const BEncodingRun		SJIS_8171(0x8171, 0x817A, 0x3008);

const uint16	SJISBlock_817B[] = {
0xFF0B, 0x2212, 0x00B1, 0x00D7
};
const BEncodingRun		SJIS_817B(0x817B, 0x817E, SJISBlock_817B);


const uint16	SJISBlock_8180[] = {
...
0x25A1, 0x25A0, 0x25B3, 0x25B2, 0x25BD, 0x25BC, 0x203B, 0x3012, 0x2192, 0x2190, 0x2191, 0x2193, 0x3013
};
const BEncodingRun		SJIS_8180(0x8180, 0x81AC, SJISBlock_8180);


const uint16	SJISBlock_81B8[] = {
0x2208, 0x220B, 0x2286, 0x2287, 0x2282, 0x2283, 0x222A, 0x2229
};
const BEncodingRun		SJIS_81B8(0x81B8, 0x81BF, SJISBlock_81B8);


const uint16	SJISBlock_81C8[] = {
0x2227, 0x2228, 0x00AC, 0x21D2, 0x21D4, 0x2200, 0x2203
};
const BEncodingRun		SJIS_81C8(0x81C8, 0x81CE, SJISBlock_81C8);


const uint16	SJISBlock_81DA[] = {
0x2220, 0x22A5, 0x2312, 0x2202, 0x2207, 0x2261, 0x2252, 0x226A, 0x226B, 0x221A, 0x223D, 0x221D, 0x2235, 0x222B, 0x222C
};
const BEncodingRun		SJIS_81DA(0x81DA, 0x81E8, SJISBlock_81DA);


const uint16	SJISBlock_81F0[] = {
0x212B, 0x2030, 0x266F, 0x266D, 0x266A, 0x2020, 0x2021, 0x00B6
};
const BEncodingRun		SJIS_81F0(0x81F0, 0x81F7, SJISBlock_81F0);

const BEncodingRun		SJIS_824F(0x824F, 0x8258, 0xFF10);
const BEncodingRun		SJIS_8260(0x8260, 0x8279, 0xFF21);
const BEncodingRun		SJIS_8281(0x8281, 0x829A, 0xFF41);
const BEncodingRun		SJIS_829F(0x829F, 0x82F1, 0x3041);
const BEncodingRun		SJIS_8340(0x8340, 0x837E, 0x30A1);
const BEncodingRun		SJIS_8380(0x8380, 0x8396, 0x30E0);
const BEncodingRun		SJIS_839F(0x839F, 0x83AF, 0x0391);
const BEncodingRun		SJIS_83B0(0x83B0, 0x83B6, 0x03A3);
const BEncodingRun		SJIS_83BF(0x83BF, 0x83CF, 0x03B1);
const BEncodingRun		SJIS_83D0(0x83D0, 0x83D6, 0x03C3);
const BEncodingRun		SJIS_8440(0x8440, 0x8445, 0x0410);
const BEncodingRun		SJIS_8447(0x8447, 0x8460, 0x0416);
const BEncodingRun		SJIS_8470(0x8470, 0x8475, 0x0430);
const BEncodingRun		SJIS_8477(0x8477, 0x847E, 0x0436);
const BEncodingRun		SJIS_8480(0x8480, 0x8491, 0x043E);

const uint16	SJISBlock_849F[] = {
...
const BEncodingRun		SJIS_849F(0x849F, 0x84BE, SJISBlock_849F);


const uint16	SJISBlock_889F[] = {
...
const BEncodingRun		SJIS_889F(0x889F, 0x88FC, SJISBlock_889F);


const uint16	SJISBlock_8940[] = {
...
0x82F1, 0x885B, 0x8A60, 0x92ED, 0x6DB2, 0x75AB, 0x76CA, 0x99C5, 0x60A6, 0x8B01, 0x8D8A, 0x95B2, 0x698E, 0x53AD, 0x5186
};
const BEncodingRun		SJIS_8940(0x8940, 0x897E, SJISBlock_8940);


const uint16	SJISBlock_8980[] = {
...
const BEncodingRun		SJIS_8980(0x8980, 0x89FC, SJISBlock_8980);


const uint16	SJISBlock_8A40[] = {
...
0x89D2, 0x8D6B, 0x8F03, 0x90ED, 0x95A3, 0x9694, 0x9769, 0x5B66, 0x5CB3, 0x697D, 0x984D, 0x984E, 0x639B, 0x7B20, 0x6A2B
};
const BEncodingRun		SJIS_8A40(0x8A40, 0x8A7E, SJISBlock_8A40);


const uint16	SJISBlock_8A80[] = {
...
const BEncodingRun		SJIS_8A80(0x8A80, 0x8AFC, SJISBlock_8A80);


const uint16	SJISBlock_8B40[] = {
...
0x5374, 0x5BA2, 0x811A, 0x8650, 0x9006, 0x4E18, 0x4E45, 0x4EC7, 0x4F11, 0x53CA, 0x5438, 0x5BAE, 0x5F13, 0x6025, 0x6551
};
const BEncodingRun		SJIS_8B40(0x8B40, 0x8B7E, SJISBlock_8B40);


const uint16	SJISBlock_8B80[] = {
...
const BEncodingRun		SJIS_8B80(0x8B80, 0x8BFC, SJISBlock_8B80);


const uint16	SJISBlock_8C40[] = {
...
0x7D99, 0x7E4B, 0x7F6B, 0x830E, 0x834A, 0x86CD, 0x8A08, 0x8A63, 0x8B66, 0x8EFD, 0x981A, 0x9D8F, 0x82B8, 0x8FCE, 0x9BE8
};
const BEncodingRun		SJIS_8C40(0x8C40, 0x8C7E, SJISBlock_8C40);


const uint16	SJISBlock_8C80[] = {
...
const BEncodingRun		SJIS_8C80(0x8C80, 0x8CFC, SJISBlock_8C80);


const uint16	SJISBlock_8D40[] = {
...
0x818F, 0x822A, 0x8352, 0x884C, 0x8861, 0x8B1B, 0x8CA2, 0x8CFC, 0x90CA, 0x9175, 0x9271, 0x783F, 0x92FC, 0x95A4, 0x964D
};
const BEncodingRun		SJIS_8D40(0x8D40, 0x8D7E, SJISBlock_8D40);


const uint16	SJISBlock_8D80[] = {
...
const BEncodingRun		SJIS_8D80(0x8D80, 0x8DFC, SJISBlock_8D80);


const uint16	SJISBlock_8E40[] = {
...
0x59FF, 0x5B50, 0x5C4D, 0x5E02, 0x5E2B, 0x5FD7, 0x601D, 0x6307, 0x652F, 0x5B5C, 0x65AF, 0x65BD, 0x65E8, 0x679D, 0x6B62
};
const BEncodingRun		SJIS_8E40(0x8E40, 0x8E7E, SJISBlock_8E40);


const uint16	SJISBlock_8E80[] = {
...
const BEncodingRun		SJIS_8E80(0x8E80, 0x8EFC, SJISBlock_8E80);


const uint16	SJISBlock_8F40[] = {
...
0x8853, 0x8FF0, 0x4FCA, 0x5CFB, 0x6625, 0x77AC, 0x7AE3, 0x821C, 0x99FF, 0x51C6, 0x5FAA, 0x65EC, 0x696F, 0x6B89, 0x6DF3
};
const BEncodingRun		SJIS_8F40(0x8F40, 0x8F7E, SJISBlock_8F40);


const uint16	SJISBlock_8F80[] = {
...
const BEncodingRun		SJIS_8F80(0x8F80, 0x8FFC, SJISBlock_8F80);


const uint16	SJISBlock_9040[] = {
...
0x58EC, 0x5C0B, 0x751A, 0x5C3D, 0x814E, 0x8A0A, 0x8FC5, 0x9663, 0x976D, 0x7B25, 0x8ACF, 0x9808, 0x9162, 0x56F3, 0x53A8
};
const BEncodingRun		SJIS_9040(0x9040, 0x907E, SJISBlock_9040);


const uint16	SJISBlock_9080[] = {
...
const BEncodingRun		SJIS_9080(0x9080, 0x90FC, SJISBlock_9080);


const uint16	SJISBlock_9140[] = {
...
0x53E2, 0x5009, 0x55AA, 0x58EE, 0x594F, 0x723D, 0x5B8B, 0x5C64, 0x531D, 0x60E3, 0x60F3, 0x635C, 0x6383, 0x633F, 0x63BB
};
const BEncodingRun		SJIS_9140(0x9140, 0x917E, SJISBlock_9140);


const uint16	SJISBlock_9180[] = {
...
const BEncodingRun		SJIS_9180(0x9180, 0x91FC, SJISBlock_9180);


const uint16	SJISBlock_9240[] = {
...
0x6065, 0x667A, 0x6C60, 0x75F4, 0x7A1A, 0x7F6E, 0x81F4, 0x8718, 0x9045, 0x99B3, 0x7BC9, 0x755C, 0x7AF9, 0x7B51, 0x84C4
};
const BEncodingRun		SJIS_9240(0x9240, 0x927E, SJISBlock_9240);


const uint16	SJISBlock_9280[] = {
...
const BEncodingRun		SJIS_9280(0x9280, 0x92FC, SJISBlock_9280);


const uint16	SJISBlock_9340[] = {
...
0x83DF, 0x8CED, 0x9014, 0x90FD, 0x934D, 0x7825, 0x783A, 0x52AA, 0x5EA6, 0x571F, 0x5974, 0x6012, 0x5012, 0x515A, 0x51AC
};
const BEncodingRun		SJIS_9340(0x9340, 0x937E, SJISBlock_9340);


const uint16	SJISBlock_9380[] = {
...
const BEncodingRun		SJIS_9380(0x9380, 0x93FC, SJISBlock_9380);


const uint16	SJISBlock_9440[] = {
...
0x5EC3, 0x62DD, 0x6392, 0x6557, 0x676F, 0x76C3, 0x724C, 0x80CC, 0x80BA, 0x8F29, 0x914D, 0x500D, 0x57F9, 0x5A92, 0x6885
};
const BEncodingRun		SJIS_9440(0x9440, 0x947E, SJISBlock_9440);


const uint16	SJISBlock_9480[] = {
...
const BEncodingRun		SJIS_9480(0x9480, 0x94FC, SJISBlock_9480);


const uint16	SJISBlock_9540[] = {
...
0x983B, 0x654F, 0x74F6, 0x4E0D, 0x4ED8, 0x57E0, 0x592B, 0x5A66, 0x5BCC, 0x51A8, 0x5E03, 0x5E9C, 0x6016, 0x6276, 0x6577
};
const BEncodingRun		SJIS_9540(0x9540, 0x957E, SJISBlock_9540);


const uint16	SJISBlock_9580[] = {
...
const BEncodingRun		SJIS_9580(0x9580, 0x95FC, SJISBlock_9580);


const uint16	SJISBlock_9640[] = {
...
0x6734, 0x7267, 0x7766, 0x7A46, 0x91E6, 0x52C3, 0x6CA1, 0x6B86, 0x5800, 0x5E4C, 0x5954, 0x672C, 0x7FFB, 0x51E1, 0x76C6
};
const BEncodingRun		SJIS_9640(0x9640, 0x967E, SJISBlock_9640);


const uint16	SJISBlock_9680[] = {
...
const BEncodingRun		SJIS_9680(0x9680, 0x96FC, SJISBlock_9680);


const uint16	SJISBlock_9740[] = {
...
0x7528, 0x7AAF, 0x7F8A, 0x8000, 0x8449, 0x84C9, 0x8981, 0x8B21, 0x8E0A, 0x9065, 0x967D, 0x990A, 0x617E, 0x6291, 0x6B32
};
const BEncodingRun		SJIS_9740(0x9740, 0x977E, SJISBlock_9740);


const uint16	SJISBlock_9780[] = {
...
const BEncodingRun		SJIS_9780(0x9780, 0x97FC, SJISBlock_9780);


const uint16	SJISBlock_9840[] = {
...
const BEncodingRun		SJIS_9840(0x9840, 0x9872, SJISBlock_9840);


const uint16	SJISBlock_989F[] = {
...
const BEncodingRun		SJIS_989F(0x989F, 0x98FC, SJISBlock_989F);


const uint16	SJISBlock_9940[] = {
...
0x51AA, 0x51AB, 0x51B3, 0x51B1, 0x51B2, 0x51B0, 0x51B5, 0x51BD, 0x51C5, 0x51C9, 0x51DB, 0x51E0, 0x8655, 0x51E9, 0x51ED
};
const BEncodingRun		SJIS_9940(0x9940, 0x997E, SJISBlock_9940);


const uint16	SJISBlock_9980[] = {
...
const BEncodingRun		SJIS_9980(0x9980, 0x99FC, SJISBlock_9980);


const uint16	SJISBlock_9A40[] = {
...
0x55D4, 0x5614, 0x55F7, 0x5616, 0x55FE, 0x55FD, 0x561B, 0x55F9, 0x564E, 0x5650, 0x71DF, 0x5634, 0x5636, 0x5632, 0x5638
};
const BEncodingRun		SJIS_9A40(0x9A40, 0x9A7E, SJISBlock_9A40);


const uint16	SJISBlock_9A80[] = {
...
const BEncodingRun		SJIS_9A80(0x9A80, 0x9AFC, SJISBlock_9A80);


const uint16	SJISBlock_9B40[] = {
...
0x5B45, 0x5B40, 0x5B51, 0x5B55, 0x5B5A, 0x5B5B, 0x5B65, 0x5B69, 0x5B70, 0x5B73, 0x5B75, 0x5B78, 0x6588, 0x5B7A, 0x5B80
};
const BEncodingRun		SJIS_9B40(0x9B40, 0x9B7E, SJISBlock_9B40);


const uint16	SJISBlock_9B80[] = {
...
const BEncodingRun		SJIS_9B80(0x9B80, 0x9BFC, SJISBlock_9B80);


const uint16	SJISBlock_9C40[] = {
...
0x5F98, 0x5FA0, 0x5FA8, 0x5FAD, 0x5FBC, 0x5FD6, 0x5FFB, 0x5FE4, 0x5FF8, 0x5FF1, 0x5FDD, 0x60B3, 0x5FFF, 0x6021, 0x6060
};
const BEncodingRun		SJIS_9C40(0x9C40, 0x9C7E, SJISBlock_9C40);


const uint16	SJISBlock_9C80[] = {
...
const BEncodingRun		SJIS_9C80(0x9C80, 0x9CFC, SJISBlock_9C80);


const uint16	SJISBlock_9D40[] = {
...
0x633E, 0x634D, 0x641C, 0x634F, 0x6396, 0x638E, 0x6380, 0x63AB, 0x6376, 0x63A3, 0x638F, 0x6389, 0x639F, 0x63B5, 0x636B
};
const BEncodingRun		SJIS_9D40(0x9D40, 0x9D7E, SJISBlock_9D40);


const uint16	SJISBlock_9D80[] = {
...
const BEncodingRun		SJIS_9D80(0x9D80, 0x9DFC, SJISBlock_9D80);


const uint16	SJISBlock_9E40[] = {
...
0x67DD, 0x67E2, 0x67EE, 0x67B9, 0x67CE, 0x67C6, 0x67E7, 0x6A9C, 0x681E, 0x6846, 0x6829, 0x6840, 0x684D, 0x6832, 0x684E
};
const BEncodingRun		SJIS_9E40(0x9E40, 0x9E7E, SJISBlock_9E40);


const uint16	SJISBlock_9E80[] = {
...
const BEncodingRun		SJIS_9E80(0x9E80, 0x9EFC, SJISBlock_9E80);


const uint16	SJISBlock_9F40[] = {
...
0x6BAB, 0x6BAF, 0x6BB2, 0x6BB1, 0x6BB3, 0x6BB7, 0x6BBC, 0x6BC6, 0x6BCB, 0x6BD3, 0x6BDF, 0x6BEC, 0x6BEB, 0x6BF3, 0x6BEF
};
const BEncodingRun		SJIS_9F40(0x9F40, 0x9F7E, SJISBlock_9F40);


const uint16	SJISBlock_9F80[] = {
...
const BEncodingRun		SJIS_9F80(0x9F80, 0x9FFC, SJISBlock_9F80);


const uint16	SJISBlock_E040[] = {
...
0x703E, 0x7032, 0x7051, 0x7063, 0x7099, 0x7092, 0x70AF, 0x70F1, 0x70AC, 0x70B8, 0x70B3, 0x70AE, 0x70DF, 0x70CB, 0x70DD
};
const BEncodingRun		SJIS_E040(0xE040, 0xE07E, SJISBlock_E040);


const uint16	SJISBlock_E080[] = {
...
const BEncodingRun		SJIS_E080(0xE080, 0xE0FC, SJISBlock_E080);


const uint16	SJISBlock_E140[] = {
...
0x75B3, 0x75C3, 0x75B5, 0x75BD, 0x75B8, 0x75BC, 0x75B1, 0x75CD, 0x75CA, 0x75D2, 0x75D9, 0x75E3, 0x75DE, 0x75FE, 0x75FF
};
const BEncodingRun		SJIS_E140(0xE140, 0xE17E, SJISBlock_E140);


const uint16	SJISBlock_E180[] = {
...
const BEncodingRun		SJIS_E180(0xE180, 0xE1FC, SJISBlock_E180);


const uint16	SJISBlock_E240[] = {
...
0x7A61, 0x7A62, 0x7A69, 0x9F9D, 0x7A70, 0x7A79, 0x7A7D, 0x7A88, 0x7A97, 0x7A95, 0x7A98, 0x7A96, 0x7AA9, 0x7AC8, 0x7AB0
};
const BEncodingRun		SJIS_E240(0xE240, 0xE27E, SJISBlock_E240);


const uint16	SJISBlock_E280[] = {
...
const BEncodingRun		SJIS_E280(0xE280, 0xE2FC, SJISBlock_E280);


const uint16	SJISBlock_E340[] = {
...
0x7E23, 0x7E21, 0x7E12, 0x7E31, 0x7E1F, 0x7E09, 0x7E0B, 0x7E22, 0x7E46, 0x7E66, 0x7E3B, 0x7E35, 0x7E39, 0x7E43, 0x7E37
};
const BEncodingRun		SJIS_E340(0xE340, 0xE37E, SJISBlock_E340);


const uint16	SJISBlock_E380[] = {
...
const BEncodingRun		SJIS_E380(0xE380, 0xE3FC, SJISBlock_E380);


const uint16	SJISBlock_E440[] = {
...
0x820A, 0x820D, 0x8210, 0x8216, 0x8229, 0x822B, 0x8238, 0x8233, 0x8240, 0x8259, 0x8258, 0x825D, 0x825A, 0x825F, 0x8264
};
const BEncodingRun		SJIS_E440(0xE440, 0xE47E, SJISBlock_E440);


const uint16	SJISBlock_E480[] = {
...
const BEncodingRun		SJIS_E480(0xE480, 0xE4FC, SJISBlock_E480);


const uint16	SJISBlock_E540[] = {
...
0x86AA, 0x868B, 0x868C, 0x86B6, 0x86AF, 0x86C4, 0x86C6, 0x86B0, 0x86C9, 0x8823, 0x86AB, 0x86D4, 0x86DE, 0x86E9, 0x86EC
};
const BEncodingRun		SJIS_E540(0xE540, 0xE57E, SJISBlock_E540);


const uint16	SJISBlock_E580[] = {
...
const BEncodingRun		SJIS_E580(0xE580, 0xE5FC, SJISBlock_E580);


const uint16	SJISBlock_E640[] = {
...
0x8A84, 0x8AA8, 0x8AA1, 0x8A91, 0x8AA5, 0x8AA6, 0x8A9A, 0x8AA3, 0x8AC4, 0x8ACD, 0x8AC2, 0x8ADA, 0x8AEB, 0x8AF3, 0x8AE7
};
const BEncodingRun		SJIS_E640(0xE640, 0xE67E, SJISBlock_E640);


const uint16	SJISBlock_E680[] = {
...
const BEncodingRun		SJIS_E680(0xE680, 0xE6FC, SJISBlock_E680);


const uint16	SJISBlock_E740[] = {
...
0x8F1B, 0x8F0C, 0x8F26, 0x8F33, 0x8F3B, 0x8F39, 0x8F45, 0x8F42, 0x8F3E, 0x8F4C, 0x8F49, 0x8F46, 0x8F4E, 0x8F57, 0x8F5C
};
const BEncodingRun		SJIS_E740(0xE740, 0xE77E, SJISBlock_E740);


const uint16	SJISBlock_E780[] = {
...
const BEncodingRun		SJIS_E780(0xE780, 0xE7FC, SJISBlock_E780);


const uint16	SJISBlock_E840[] = {
...
0x9475, 0x9477, 0x947D, 0x945A, 0x947C, 0x947E, 0x9481, 0x947F, 0x9582, 0x9587, 0x958A, 0x9594, 0x9596, 0x9598, 0x9599
};
const BEncodingRun		SJIS_E840(0xE840, 0xE87E, SJISBlock_E840);


const uint16	SJISBlock_E880[] = {
...
const BEncodingRun		SJIS_E880(0xE880, 0xE8FC, SJISBlock_E880);


const uint16	SJISBlock_E940[] = {
...
0x99F1, 0x99F2, 0x99FB, 0x99F8, 0x9A01, 0x9A0F, 0x9A05, 0x99E2, 0x9A19, 0x9A2B, 0x9A37, 0x9A45, 0x9A42, 0x9A40, 0x9A43
};
const BEncodingRun		SJIS_E940(0xE940, 0xE97E, SJISBlock_E940);


const uint16	SJISBlock_E980[] = {
...
const BEncodingRun		SJIS_E980(0xE980, 0xE9FC, SJISBlock_E980);


const uint16	SJISBlock_EA40[] = {
...
0x9EAA, 0x9EAD, 0x9761, 0x9ECC, 0x9ECE, 0x9ECF, 0x9ED0, 0x9ED4, 0x9EDC, 0x9EDE, 0x9EDD, 0x9EE0, 0x9EE5, 0x9EE8, 0x9EEF
};
const BEncodingRun		SJIS_EA40(0xEA40, 0xEA7E, SJISBlock_EA40);


const uint16	SJISBlock_EA80[] = {
...
const BEncodingRun		SJIS_EA80(0xEA80, 0xEAA4, SJISBlock_EA80);


const BEncodingRun * const SJISStack[] = {
&SJIS_00A1, &SJIS_8140, &SJIS_8171, &SJIS_817B, &SJIS_8180, &SJIS_81B8, &SJIS_81C8, &SJIS_81DA,
&SJIS_81F0, &SJIS_824F, &SJIS_8260, &SJIS_8281, &SJIS_829F, &SJIS_8340, &SJIS_8380, &SJIS_839F, &SJIS_83B0,
&SJIS_83BF, &SJIS_83D0, &SJIS_8440, &SJIS_8447, &SJIS_8470, &SJIS_8477, &SJIS_8480, &SJIS_849F, &SJIS_889F,
&SJIS_8940, &SJIS_8980, &SJIS_8A40, &SJIS_8A80, &SJIS_8B40, &SJIS_8B80, &SJIS_8C40, &SJIS_8C80, &SJIS_8D40,
&SJIS_8D80, &SJIS_8E40, &SJIS_8E80, &SJIS_8F40, &SJIS_8F80, &SJIS_9040, &SJIS_9080, &SJIS_9140, &SJIS_9180,
&SJIS_9240, &SJIS_9280, &SJIS_9340, &SJIS_9380, &SJIS_9440, &SJIS_9480, &SJIS_9540, &SJIS_9580, &SJIS_9640,
&SJIS_9680, &SJIS_9740, &SJIS_9780, &SJIS_9840, &SJIS_989F, &SJIS_9940, &SJIS_9980, &SJIS_9A40, &SJIS_9A80,
&SJIS_9B40, &SJIS_9B80, &SJIS_9C40, &SJIS_9C80, &SJIS_9D40, &SJIS_9D80, &SJIS_9E40, &SJIS_9E80, &SJIS_9F40,
&SJIS_9F80, &SJIS_E040, &SJIS_E080, &SJIS_E140, &SJIS_E180, &SJIS_E240, &SJIS_E280, &SJIS_E340, &SJIS_E380,
&SJIS_E440, &SJIS_E480, &SJIS_E540, &SJIS_E580, &SJIS_E640, &SJIS_E680, &SJIS_E740, &SJIS_E780, &SJIS_E840,
&SJIS_E880, &SJIS_E940, &SJIS_E980, &SJIS_EA40, &SJIS_EA80
};
const uint16 SJISStackSize = 94;

const BReplacement	SJISReplace_005C(0x005C, 0x00A5);
const BReplacement	SJISReplace_007E(0x007E, 0x203E);
const BReplacement	SJISReplace_81FC(0x81FC, 0x25EF);
const BReplacement	SJISReplace_8446(0x8446, 0x0401);
const BReplacement	SJISReplace_8476(0x8476, 0x0451);
const BReplacement * const SJISReplacements[] = {
&SJISReplace_005C, &SJISReplace_007E, &SJISReplace_81FC, &SJISReplace_8446,
&SJISReplace_8476
};
const uint16 SJISReplacementCount = 5;


class SJISCodec : public BTextCodec {
	public:
									SJISCodec(BTextEncodingAddOn *addOn, uint32 flags);
		virtual						~SJISCodec();
	...
	protected:
		uint16						AdjustCharcode(uint16 charcode, bool convert_to = true) const;
};


SJISCodec::SJISCodec(BTextEncodingAddOn *addOn, uint32 flags) :
	BTextCodec(SJISStack, SJISStackSize, SJISReplacements, SJISReplacementCount, addOn, flags |= USES_ASCII)
{
}
...
uint16 
SJISCodec::AdjustCharcode(uint16 charcode, bool convert_to) const
{
	uint16 retCode = charcode;
	uchar fb = (charcode >> 8) & 0xFF;
	uchar sb = charcode & 0xFF;
	if (convert_to) {
		if (is_initial_euc_set1_byte(sb)) {
			fb -= 128;
			sb -=  128;
			uchar rowOffset = (fb < 95) ? 112 : 176;
			uchar cellOffset = (fb % 2) ? ((sb > 95) ? 32 : 31) : 126;
			fb = ((fb + 1) >> 1) + rowOffset;
			sb += cellOffset;
			retCode = (fb << 8) | (sb);
		}		
		else if (is_initial_euc_set2_byte(fb)) {
			retCode = sb;
		}
	}
	else {
		if (charcode >= 0xA1 && charcode <= 0xDF) {
			retCode = (0x8e << 8) | (uchar)charcode;
		}
		else if (charcode > 0xff) {
			uchar adjust = (sb < 0x9F) ? 1 : 0;
			uchar rowOffset = (fb < 0xA0) ? 0x70 : 0xB0;
			uchar cellOffset = (adjust != 0) ? ((sb > 0x7f) ? 0x20 : 0x1f) : 0x7E;
			uchar c1 = ((fb - rowOffset) << 1) - adjust + 0x80;
			uchar c2 = (uchar) (sb - cellOffset) + 0x80;
			retCode = (c1 << 8) | c2;
		}
	}
	return retCode;
...
status_t
SJISCodec::ConvertToUnicode(const char *src, int32 *srcLen, char *dst, int32 *dstLen, conversion_info &info, BEncodingStack *stack) const
{
//	printf("SJISCodec::ConvertToUnicode() -----------------------------------------\n");
	...
	while ((srcPos < srcEnd) && (dstPos < dstEnd)) {
		...
		// only EUC has the adjust function
		// if it is not EUC then we need to exclude the single-byte codes > 0x80
		if (c > 0x80 && ((fFlags & ADJUST_FUNCTION) || is_initial_sjis_byte(c))) {
			if (srcPos + 1 < srcEnd) {
				charcode = (c << 8) | ((uchar)src[srcPos +1]);
				multibyte = true;
			}
		}
...
status_t 
SJISCodec::ConvertFromUnicode(const char *src, int32 *srcLen, char *dst, int32 *dstLen, conversion_info &info, BEncodingStack *stack) const
{
	uint16 *unistr = (uint16*) src;
	int32 srcEnd = (!info.unicode) ? *srcLen : *srcLen / sizeof(uint16);
	int32 dstEnd = *dstLen;
	int32 srcPos = 0;
	int32 dstPos = 0;
	...
	while ((srcPos < srcEnd) && (dstPos < dstEnd)) {
		...
		if (stack) {
			charcode = stack->CharcodeFor(unicode);
		}
		if (charcode == 0xffff) {
			charcode = CharcodeFor(unicode);
		}
		...
		// write the value out to the new string
		if (charcode > 0xff) {
			if ((dstPos + 1) < dstEnd) {
	...
	*srcLen = (!info.unicode) ? srcPos : srcPos * sizeof(uint16);
	*dstLen = dstPos;
...
class JISCodec : public BTextCodec {
	public:
									JISCodec(BTextEncodingAddOn *addOn);
		virtual						~JISCodec();
		virtual status_t			ConvertToUnicode(const char *src, int32 *srcLen, char *dst, int32 *dstLen, conversion_info &info, BEncodingStack *stack) const;
		virtual status_t			ConvertFromUnicode(const char *src, int32 *srcLen, char *dst, int32 *dstLen, conversion_info &info, BEncodingStack *stack) const;
};
...
JISCodec::JISCodec(BTextEncodingAddOn *addOn) :
	BTextCodec(SJISStack, SJISStackSize, SJISReplacements, SJISReplacementCount, addOn,  USES_ASCII)
{
}
...
status_t 
JISCodec::ConvertToUnicode(const char *src, int32 *srcLen, char *dst, int32 *dstLen, conversion_info &info, BEncodingStack *stack) const
{
//	printf("SJISCodec::ConvertToUnicode() -----------------------------------------\n");
	uint16 *unistr = (uint16 *)dst;
	int32 srcEnd = *srcLen;
	...
	int32 dstPos = 0;
	uint16 charcode = 0;
	bool multibyte = (info.state == kInKanjiMode);		
...
/// -- start of difference between EUC && SJIS
		if (c == 0x1B) {
			if (srcPos + 1 >= srcEnd)
				break;
			int32 escapeOffset = skip_jis_escape((uchar)src[srcPos + 1], &multibyte);
	
			if (escapeOffset != 0) {
				if ((srcPos + escapeOffset) < srcEnd) {
					srcPos += escapeOffset;
					continue;
				}
				else
...
/// -- end of difference between EUC && SJIS
	...
	*srcLen = srcPos;
	*dstLen = (!info.unicode) ? dstPos : dstPos * sizeof(uint16);
	info.state = (multibyte) ? kInKanjiMode : 0;
	return (dstPos > 0) ? B_OK : B_ERROR;
}
...
status_t 
JISCodec::ConvertFromUnicode(const char *src, int32 *srcLen, char *dst, int32 *dstLen, conversion_info &info, BEncodingStack *stack) const
{
	uint16 *unistr = (uint16*) src;
	int32 srcEnd = (!info.unicode) ? *srcLen : *srcLen / sizeof(uint16);
	int32 dstEnd = *dstLen;
	int32 srcPos = 0;
	int32 dstPos = 0;
	bool	inKanjiMode = (info.state == kInKanjiMode);	
	while ((srcPos < srcEnd) && (dstPos < dstEnd)) {
		// determine the unicode character to try and convert
		bool multibyte = false;
		if ((srcPos + utf8_char_len(src[srcPos])) > srcEnd)
		...
		// jis cannot use half-width katakana - so must convert to full-width
...
// -- start of differences between JIS and SJIS
		// convert sjis to jis
		
		uint16 jisCode = charcode;
		charcode = 0x0000;
		
		if (jisCode <= 0xff) {
			if (inKanjiMode) {
				// we need to write out the escape sequence for
				// going back to single byte
				// the escape sequence is 3 bytes
				if ((dstPos + 2) < dstEnd) {
					dst[dstPos] = 0x1B;
					dst[dstPos+1] = '(';
					dst[dstPos+2] = 'J';
			...
			if (!inKanjiMode) {
				// we need to write out the escape sequence for
				// going back to multibyte
				// the escape sequence is 3 bytes long
				if ((dstPos + 2) < dstEnd) {
					dst[dstPos] = 0x1B;
					dst[dstPos+1] = '$';
					dst[dstPos+2] = 'B';
			...
			uchar fb = (jisCode >> 8) & 0xFF;
			uchar sb = jisCode & 0xFF;
			uchar adjust = (sb < 0x9F) ? 1 : 0;
			uchar rowOffset = (fb < 0xA0) ? 0x70 : 0xB0;
			uchar cellOffset = (adjust != 0) ? ((sb > 0x7f) ? 0x20 : 0x1f) : 0x7E;
			uchar c1 = ((fb - rowOffset) << 1) - adjust;
			uchar c2 = (uchar) (sb - cellOffset);
			charcode = (c1 << 8) | c2;
			multibyte = true;
		}
		
// -- end of difference between JIS and SJIS
		// write the value out to the new string
		if (charcode > 0xff) {
			if ((dstPos + 1) < dstEnd) {
				dst[dstPos] = (charcode >> 8) & 0xff;
			...
			dst[dstPos] = ((uchar)charcode) & 0x7F;
	...
	*srcLen = (!info.unicode) ? srcPos : srcPos * sizeof(uint16);
	*dstLen = dstPos;
	info.state = (inKanjiMode) ? kInKanjiMode : 0;
	return (srcPos > 0) ? B_OK : B_ERROR;
}
...
BTextCodec * make_codec(const char * encoding, BTextEncodingAddOn *addOn) {
	if (strcasecmp(encoding, SJISName) == 0)
		return new SJISCodec(addOn, 0);
	else if (strcasecmp(encoding, EUCName) == 0)
		return new SJISCodec(addOn, ADJUST_FUNCTION);
	else if (strcasecmp(encoding, JISName) == 0)
		return new JISCodec(addOn);
	else
		return NULL;
}
