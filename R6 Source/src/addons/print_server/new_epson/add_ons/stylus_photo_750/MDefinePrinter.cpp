...
const char *gName = "Epson Stylus Photo 750";
const tPrinterInfo gPrinterInfo =
{
	gName,						// Name
	ID_STYLUS_PHOTO_750,		// ID
	3,							// DefaultPage
	48,							// Nb Black Nozzles
	48,							// Nb Color Nozzles
...
const tPrinterRes gRes[] = {
		...
		{ "Normal (720 Dpi)",		720, 360 },
		{ "Fine (720 Dpi)",			720, 720 },
...
const tPrinterPaper gPaper[] = {
		...
		{ "360 DPI Ink Jet paper"				},	// 360 inkjet				: 360 dpi
								};
...
const uint8 paperFeedValue[sizeof(gPage)/sizeof(tPage)][sizeof(gPaper)/sizeof(tPrinterPaper)] = {
	...
	{ 1, 0, 0, 3, 3, 1 },	// a5
	{ 1, 0, 0, 3, 3, 1 },	// a6
	{ 1, 0, 0, 3, 3, 1 },	// executive
	{ 1, 0, 0, 3, 3, 1 },	// half letter
	{ 2, 2, 0, 3, 3, 2 },	// index 5x8
	{ 2, 2, 0, 3, 3, 2 },	// index 8x10
	{ 4, 4, 0, 3, 3, 4 },	// #10 envelope
	{ 4, 4, 0, 3, 3, 4 },	// DL
	{ 4, 4, 0, 3, 3, 4 },	// C6
	{ 1, 0, 0, 3, 3, 1 },	// photo paper
	{ 1, 0, 0, 3, 3, 1 },	// panoramique
};
...
const tRes2Paper gRes2Paper[] =	{
									{1, 0, 1,	2, 2, 0x0000 },	// 720x360 plain 1
									{3, 0, 2,	4, 2, 0x0020 },	// 720x720 plain 2
									{4, 0, 2,	4, 2, 0x0040 },	// 1440x720 plain 2
									
									{2, 1, 1,	2, 2, 0x0001 },	// 720x720 inkjet 1
									{3, 1, 2,	4, 2, 0x0021 },	// 720x720 inkjet 2
									{4, 1, 2,	4, 2, 0x0041 },	// 1440x720 inkjet 2
									
									{2, 2, 1,	2, 2, 0x0001 },	// 720x720 photo 1
									{3, 2, 2,	4, 2, 0x0021 },	// 720x720 photo 2
									{4, 2, 2,	4, 2, 0x0041 },	// 1440x720 photo 2
									
									{3, 3, 2,	4, 2, 0x0021 },	// 720x720 glossy 2
									{4, 3, 2,	4, 2, 0x0041 },	// 1440x720 glossy 2
									
									{1, 5, 1,	2, 2, 0x0001 },	// 720x360 inkjet360 1
									{0, 4, 1,	3, 2, 0x0021 },	// 360x360 transparency 1
								};
