/*
	...
	File:		attrcipg.h	"@(#)attrcipg.h	1.11 8/21/97"

	Contains:
			This module is the include file for the private CIPG KCMS attribute
			interface.  It must be included in any source file using KCMS
			attributes.  There are definitions for all enums needed for use
			with attributes.
...
/****************************************************************
  ...
  COPYRIGHT (c) 1991, 1992 KEPS, Inc.
...
/* Chainning Classes */
#define	KCM_CHAIN_CLASS_RCS			1		/* RCS, (simulate, effects), Scanner RGB, Photo CD in */
