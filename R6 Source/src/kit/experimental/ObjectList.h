...
// This was taken from the private support kit interface, so that
// programs linked with the experimental column list view will not
// accidentially become bound to our private functions.
