...
status_t ReadFrames__11BMediaTrackFPcPxP12media_header(BMediaTrack * mt, void * buf, int64 * cnt, media_header * hdr)
#else
...
#if defined(__MWERKS__)
status_t ReplaceFrames__11BMediaTrackFPcPxPC12media_header(BMediaTrack * mt, const void * buf, int64 * cnt, media_header * hdr)
#else
...
status_t
BMediaTrack::ReplaceFrames(const void *in_buffer, int64 *io_frameCount,
