#ifndef _MEDIA2_TRACK_H_
#define _MEDIA2_TRACK_H_
...
private:
					...
					BMediaTrack(B::Private::MediaExtractor *extractor, int32 stream);
					BMediaTrack(B::Private::Detractor *detractor, int32 stream);

					// for write-only access to a BMediaTrack
					BMediaTrack(B::Private::MediaWriter *writer,
								int32 stream_num,
								media_format *in_format,
								B::Private::Encoder *encoder,
...
friend class B::Private::Decoder;
...
static	B::Private::Decoder *	find_decoder(BMediaTrack *track, int32 *id);
