...
_EXPORT BE_ERR	beInitStream(PBE_CONFIG pbeConfig, PDWORD dwSamples, PDWORD dwBufferSize, PHBE_STREAM phbeStream);
_EXPORT BE_ERR	beEncodeChunk(HBE_STREAM hbeStream, DWORD nSamples, PSHORT pSamples, PBYTE pOutput, PDWORD pdwOutput);
_EXPORT BE_ERR	beDeinitStream(HBE_STREAM hbeStream, PBYTE pOutput, PDWORD pdwOutput);
_EXPORT BE_ERR	beCloseStream(HBE_STREAM hbeStream);
_EXPORT VOID		beVersion(PBE_VERSION pbeVersion);
_EXPORT BE_ERR	beWriteVBRHeader(LPCSTR lpszFileName);
