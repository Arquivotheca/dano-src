...
/*
 * fut_interp_lin3d8 computes the trilinear (3D) interpolation in the grid
 * table given (x,y,z) from the input tables.
 */

int
	fut_interp_lin3d8 (generic_u_int8_ptr_t rp, generic_u_int8_ptr_t zp,
					generic_u_int8_ptr_t yp, generic_u_int8_ptr_t xp, int32 n,
