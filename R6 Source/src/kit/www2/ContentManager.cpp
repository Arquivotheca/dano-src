...
{
#warning "Fix me ContentHandle::LoadIdentifiers"
...
Protocol* ContentManager::InstantiateProtocol(const char* scheme)
{
	...
	ContentHandle* ch = FindContentHandle(S_PROTOCOL_SCHEMES.AsString(), scheme, false);
	if( !ch ) ch = FindContentHandle(S_PROTOCOL_SCHEMES.AsString(), scheme, true);
	if (!ch) {
...
{
#warning "Fix me ContentManager::InstantiateHandle"
