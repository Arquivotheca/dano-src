...
public:
	...
	void AttachedToWindow()
	{
		...
		AddChild(new BStringView(BRect(10, 10, 220, 35), B_EMPTY_STRING, "WhackLoader — the screen saver factory"));
		AddChild(new BStringView(BRect(25, 80, 220, 95), B_EMPTY_STRING, "Pick your favorites in Whack"));
		AddChild(new BStringView(BRect(25, 96, 220, 111), B_EMPTY_STRING, "to populate this menu"));
