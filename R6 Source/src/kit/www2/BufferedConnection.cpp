...
ssize_t	BufferedConnection::ReadV(const iovec *vector, ssize_t count)
{
...
ssize_t	BufferedConnection::WriteV(const iovec *vector, ssize_t count)
{
#warning "Implement BufferedConnection::WriteV"
}

status_t BufferedConnection::End()
{
#warning "Implement BufferedConnection::End"
}

status_t BufferedConnection::Sync()
{
