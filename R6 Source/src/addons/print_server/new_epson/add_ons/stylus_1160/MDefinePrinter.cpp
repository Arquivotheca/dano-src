...
const char *gName = "Epson Stylus Color 1160";
...
const tPrinterPaper gPaper[] = {
		...
		{ "Inkjet 360 DPI paper"				},	// Inkjet 360				: 360
...
const struct
{
	...
	{ {0,0},{0,0},{0,0},{8,1},{3,0},{3,0} },	// userdef
	{ {0,0},{0,0},{0,0},{8,1},{3,0},{3,0} },	// legal
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// letter
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// letter landscape
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// executive
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// half letter
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// a3+
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// a3
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// a4
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// a4 landscape
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// a5
	{ {2,1},{2,1},{2,1},{8,1},{3,1},{3,1} },	// a6
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// b
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// b4
	{ {1,0},{1,0},{1,0},{8,1},{3,0},{3,0} },	// b5
	{ {4,2},{4,2},{4,2},{8,2},{3,2},{3,2} },	// #10 envelope
	{ {4,2},{4,2},{4,2},{8,2},{3,2},{3,2} },	// DL
	{ {4,2},{4,2},{4,2},{8,2},{3,2},{3,2} },	// C6
	{ {4,2},{4,2},{4,2},{8,2},{3,2},{3,2} },	// envelope 132x220
	{ {2,1},{2,1},{2,1},{8,1},{3,1},{3,1} },	// postcard
	{ {2,1},{2,1},{2,1},{8,1},{3,1},{3,1} },	// return postcard
	{ {2,1},{2,1},{2,1},{8,1},{3,1},{3,1} },	// index 5x8
	{ {2,1},{2,1},{2,1},{8,1},{3,1},{3,1} },	// index 8x10
	{ {0,0},{0,0},{0,0},{8,1},{3,0},{3,0} },	// photo paper
	{ {0,0},{0,0},{0,0},{8,1},{3,0},{3,0} },	// panoramique
};
...
const tRes2Paper gRes2Paper[] =	{
									{0, 0, 0,	3, 0, 0x0000 },	// 360x360 plain
									{2, 0, 1,	3, 2, 0x0000 },	// 360x720 plain
									{3, 0, 2,	2, 2, 0x0021 },	// 720x720 plain
									{0, 1, 1,	3, 2, 0x0000 },	// 360x360 inkjet360
									{2, 2, 1,	3, 2, 0x0000 },	// 360x720 inkjet
									{3, 2, 2,	2, 2, 0x0021 },	// 720x720 inkjet
									{2, 3, 1,	3, 2, 0x0000 },	// 360x720 photo
									{3, 3, 2,	2, 2, 0x0021 },	// 720x720 photo
									{4, 4, 2,	1, 2, 0x0041 },	// 1440x720 glossy
									{0, 5, 1,	3, 2, 0x0021 },	// 360x360 transparency
								};
