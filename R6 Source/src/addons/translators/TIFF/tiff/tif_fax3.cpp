...
#ifndef lint
static char rcsid[] = "$Header: /net/bally/be/rcs_rel/src/apps/3dmov/tiff/tif_fax3.cpp,v 1.1 1996/12/22 23:45:05 pierre Exp $";
#endif
...
Fax3SetupState(TIFF* tif, int space)
{
	...
	if (is2DEncoding(tif) || td->td_compression == COMPRESSION_CCITTFAX4)
		cc += rowbytes+1;
	tif->tif_data = (tidata_t)_TIFFmalloc(cc);
