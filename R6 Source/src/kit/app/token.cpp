...
BTokenSpace* BPrivate::gDefaultTokens = NULL;

status_t _init_tokens_()
{
	BPrivate::gDefaultTokens = new BTokenSpace;
	return B_NO_ERROR;
}

status_t _delete_tokens_()
{
	ASSERT(BPrivate::gDefaultTokens);
	delete BPrivate::gDefaultTokens;
	BPrivate::gDefaultTokens = NULL;
	return B_NO_ERROR;
}
...
void    BTokenSpace::Dump(BDataIO& io, bool showFree) const
{
