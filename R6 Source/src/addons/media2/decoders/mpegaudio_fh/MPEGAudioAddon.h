...
class CMPEGAudioDecoderAddon : public B::Media2::BMediaAddon
{
	CMPEGAudioDecoderAddon (const CMPEGAudioDecoderAddon &);
	CMPEGAudioDecoderAddon &operator= (const CMPEGAudioDecoderAddon &);
	
	B::Media2::flavor_info mFlavor;
	
	public:
		CMPEGAudioDecoderAddon (image_id image);
		virtual ~CMPEGAudioDecoderAddon();
