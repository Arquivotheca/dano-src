...
**
**	3/12/99		Created from GenSynthFiltersFloat.c
*/
/*****************************************************************************/
...
void PV_ServeFloatFilterPartialBuffer (GM_Voice *this_voice, XBOOL looping)
{
	...
	{
		PV_ServeFloatFilterPartialBufferNewReverb (this_voice, looping); 
		return;
	}
#endif
	z = this_voice->z;
...
void PV_ServeStereoFloatFilterPartialBuffer (GM_Voice *this_voice, XBOOL looping)
{
	...
	{
		PV_ServeStereoFloatPartialBuffer (this_voice, looping); 
		return; 
	}
	...
	if (this_voice->reverbLevel > 1 || this_voice->chorusLevel > 1)
	{ 
		PV_ServeStereoFloatFilterPartialBufferNewReverb (this_voice, looping); 
		return; 
	}
#endif
	z = this_voice->z;
...
void PV_ServeFloatFilterFullBuffer(GM_Voice *this_voice)
{
	...
	if (this_voice->channels > 1) 
	{
		PV_ServeFloatPartialBuffer (this_voice, FALSE); 
		return; 
	}
#if (USE_SMALL_MEMORY_REVERB == FALSE) && (USE_VARIABLE_REVERB == TRUE)
	if (this_voice->reverbLevel > 1 || this_voice->chorusLevel > 1)
	{
		PV_ServeFloatFilterFullBufferNewReverb (this_voice); 
		return;
	}
#endif
	z = this_voice->z;
...
void PV_ServeStereoFloatFilterFullBuffer (GM_Voice *this_voice)
{
	...
	if (this_voice->channels > 1) 
	{
		PV_ServeStereoFloatPartialBuffer (this_voice, FALSE); 
		return; 
	}
#if (USE_SMALL_MEMORY_REVERB == FALSE) && (USE_VARIABLE_REVERB == TRUE)
	if (this_voice->reverbLevel > 1 || this_voice->chorusLevel > 1)
	{
		PV_ServeStereoFloatFilterFullBufferNewReverb (this_voice); 
		return;
	}
#endif
	z = this_voice->z;
...
{
	PV_ServeFloatFilterPartialBuffer16 (this_voice, FALSE);
}
...
void PV_ServeFloatFilterPartialBuffer16 (GM_Voice *this_voice, XBOOL looping)
{
	...
	if (this_voice->channels > 1) 
	{ 
		PV_ServeFloatPartialBuffer16 (this_voice, looping); 
		return; 
	}
#if (USE_SMALL_MEMORY_REVERB == FALSE) && (USE_VARIABLE_REVERB == TRUE)
	if (this_voice->reverbLevel > 1 || this_voice->chorusLevel > 1)
	{
		PV_ServeFloatFilterPartialBufferNewReverb16 (this_voice, looping); 
		return;
	}
#endif
	z = this_voice->z;
...
{
	PV_ServeStereoFloatFilterPartialBuffer16 (this_voice, FALSE);
}
...
void PV_ServeStereoFloatFilterPartialBuffer16 (GM_Voice *this_voice, XBOOL looping)
{
	...
	if (this_voice->reverbLevel > 1 || this_voice->chorusLevel > 1)
	{
		PV_ServeStereoFloatFilterPartialBufferNewReverb16 (this_voice, looping); 
		return;
	}
#endif
	z = this_voice->z;
