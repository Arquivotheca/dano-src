...
public:
	static MediaController *Open(const entry_ref&, BLooper *target,
		status_t *error = 0, BString *failingFormatDescription = 0);
...
protected:
	...
	virtual status_t SetTo(const entry_ref&, BString *);
...
private:
	...
	void _SetTo(const entry_ref&, const dormant_node_info *);
