#ifndef lint
static char rcsid[] = "$Header: /net/bally/be/rcs_rel/src/apps/3dmov/tiff/tif_getimage.cpp,v 1.1 1996/12/22 23:45:10 pierre Exp $";
#endif
    ...
    u_long rwidth, u_long rheight, u_long* raster, int stop)
{
	...
	default:
		TIFFError(TIFFFileName(tif),
		    "Sorry, can not handle %d-bit/sample images", bitspersample);
		return (0);
	}
