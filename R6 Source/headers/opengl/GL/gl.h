...
/* Multitexture exts */
void glMultiTexCoord1dARB (GLenum tmu, GLdouble s);
void glMultiTexCoord1dvARB (GLenum tmu, const GLdouble *v);
void glMultiTexCoord1fARB (GLenum tmu, GLfloat s);
void glMultiTexCoord1fvARB (GLenum tmu, const GLfloat *v);
void glMultiTexCoord1iARB (GLenum tmu, GLint s);
void glMultiTexCoord1ivARB (GLenum tmu, const GLint *v);
void glMultiTexCoord1sARB (GLenum tmu, GLshort s);
void glMultiTexCoord1svARB (GLenum tmu, const GLshort *v);
void glMultiTexCoord2dARB (GLenum tmu, GLdouble s, GLdouble t);
void glMultiTexCoord2dvARB (GLenum tmu, const GLdouble *v);
void glMultiTexCoord2fARB (GLenum tmu, GLfloat s, GLfloat t);
void glMultiTexCoord2fvARB (GLenum tmu, const GLfloat *v);
void glMultiTexCoord2iARB (GLenum tmu, GLint s, GLint t);
void glMultiTexCoord2ivARB (GLenum tmu, const GLint *v);
void glMultiTexCoord2sARB (GLenum tmu, GLshort s, GLshort t);
void glMultiTexCoord2svARB (GLenum tmu, const GLshort *v);
void glMultiTexCoord3dARB (GLenum tmu, GLdouble s, GLdouble t, GLdouble r);
void glMultiTexCoord3dvARB (GLenum tmu, const GLdouble *v);
void glMultiTexCoord3fARB (GLenum tmu, GLfloat s, GLfloat t, GLfloat r);
void glMultiTexCoord3fvARB (GLenum tmu, const GLfloat *v);
void glMultiTexCoord3iARB (GLenum tmu, GLint s, GLint t, GLint r);
void glMultiTexCoord3ivARB (GLenum tmu, const GLint *v);
void glMultiTexCoord3sARB (GLenum tmu, GLshort s, GLshort t, GLshort r);
void glMultiTexCoord3svARB (GLenum tmu, const GLshort *v);
void glMultiTexCoord4dARB (GLenum tmu, GLdouble s, GLdouble t, GLdouble r, GLdouble q);
void glMultiTexCoord4dvARB (GLenum tmu, const GLdouble *v);
void glMultiTexCoord4fARB (GLenum tmu, GLfloat s, GLfloat t, GLfloat r, GLfloat q);
void glMultiTexCoord4fvARB (GLenum tmu, const GLfloat *v);
void glMultiTexCoord4iARB (GLenum tmu, GLint s, GLint t, GLint r, GLint q);
void glMultiTexCoord4ivARB (GLenum tmu, const GLint *v);
void glMultiTexCoord4sARB (GLenum tmu, GLshort s, GLshort t, GLshort r, GLshort q);
void glMultiTexCoord4svARB (GLenum tmu, const GLshort *v);
void glClientActiveTextureARB(GLenum tmu);
void glActiveTextureARB(GLenum tmu);

/* BeOS Surface Management */
void glCreateSurfaceBe( GLuint id, GLuint width, GLuint height,
	GLuint color, GLuint depth, GLuint stencil, GLuint accum );
void glBindSurfaceBe( GLuint id );
void glDestroySurfaceBe( GLuint id );
void glTexSurfaceBe( GLenum target, GLint level, GLuint id );
