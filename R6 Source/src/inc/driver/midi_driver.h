...
#define B_MPU_401_MODULE_NAME_V1 "generic/mpu401/v1"
#define B_MPU_401_MODULE_NAME "generic/mpu401/v2"
...
typedef struct _generic_mpu401_module {
	...
	status_t (*create_device_alt)(int port, void * r_cookie, uchar (*read_func)(void *, int), void (*write_func)(void *, int, uchar),
			void ** out_storage, uint32 workarounds, void (*interrupt_op)(int32 op, void * card), void * card);
	int	_reserved_;
