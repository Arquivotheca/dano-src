...
{
	if (progress)
		bitmap.SetBits(bits[indx], kBarberPoleBitmapWidth * kBarberPoleBitmapHeight, 0, B_COLOR_8_BIT);
	else
		bitmap.SetBits(dropHereBits, kBarberPoleBitmapWidth * kBarberPoleBitmapHeight, 0, B_COLOR_8_BIT);
